...
<div class="sidebar columns">
	<div id="secondary" class="secondary columns">
		<ul class="accordion" data-accordion>
			<?php
			$show_docs = do_shortcode('[downloads tag=pdf,doc,docx,xls,xlsx category='. $post->post_name .'-franchisor ]');
			$show_audio = do_shortcode('[downloads tag=mp3 category='. $post->post_name .'-franchisor ]');
			$show_video = do_shortcode('[downloads tag=avi,mov,mp4 category='. $post->post_name .'-franchisor ]');
			if ($show_docs) {
