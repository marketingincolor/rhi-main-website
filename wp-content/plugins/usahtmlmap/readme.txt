...
Nice looking interactive HTML5 Map of USA for WordPress with an option to customize the view and the behavior of the map.

== Description ==

Put an interactive high-quality HTML5 Map of USA to your WordPress powered blog!
...
3. After that,  insert the map short code ie `[usahtml5map id="0"]` into the text of a page or a post where you want the map to be. Short codes can be viewed on tab "Maps".
